...
public class HandleLookupCRMProPage {
...
// driver.switchTo().frame("mainpanel");	 
	...
	//    driver.findElement(By.xpath("(//input[@value='Lookup'])[1]")).click();
	   ...
	   Set<String> lookup = driver.getWindowHandles();
	   
	   for (String look : lookup)
	   {
		   if(!look.equals(pwh))
		   {
			   driver.switchTo().window(look);
		   }
	   }
	    ...
	    driver.findElement(By.xpath("//input[@name='company_position']")).sendKeys("Leader");
       ...
       // WebElement owner = driver.findElement(By.name("owner_user_id"));
